...
class OfflineImage extends react_1.PureComponent {
    ...
    render() {
        const _a = this.props, { source, ImageComponent = react_native_1.Image, LoadingIndicatorComponent = react_native_1.ActivityIndicator, fallbackStaticSource: fallbackSource, storeName } = _a, imageProps = __rest(_a, ["source", "ImageComponent", "LoadingIndicatorComponent", "fallbackStaticSource", "storeName"]);
