...
const splitEvery_1 = __importDefault(require("ramda/es/splitEvery"));
...
class AsyncImageStore {
    ...
    initialize() {
        this.state = new State_1.State(this.config, this.name);
    ...
    preloadImage(target) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.iodriver.createBaseDirIfMissing();
    ...
    preloadImages(targets, onProgress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let i = 0;
            yield this.iodriver.createBaseDirIfMissing();
            const tasks = targets.map(target => () => __awaiter(this, void 0, void 0, function* () {
                const event = yield this.preloadImage(target);
                event && events.push(event);
                onProgress && onProgress(event, i, targets.length);
                i += 1;
            }));
            const bundlesOfTasks = splitEvery_1.default(this.config.maxParallelDownloads, tasks);
            for (const bundle of bundlesOfTasks) {
                yield Promise.all(bundle.map(f => f()));
            }
            return events;
        });
    }
    ...
    clear() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.iodriver.deleteBaseDirIfExists();
            this.initialize();
        });
    }
}
